export type SVGParams = {
  ...
  export const PowerBtn = ({ height, width, color }: SVGParams) => {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fas"
  ...
  export const Github = ({ height, width, color }: SVGParams) => {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fab"
  ...
  export const Twitter = ({ height, width, color }: SVGParams) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
  ...
  export const Linkedin = ({ height, width, color }: SVGParams) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width={height}
  ...
  export const ChatIcon = ({ width, height, color }: SVGParams) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
  ...
  export const YinYang = ({ width, height, color }: SVGParams) => {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fas"
  ...
  export const Anchor = ({ width, height, color }: SVGParams) => {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fas"
  ...
  export const Link = ({ width, height, color, className }: SVGParams) => {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fas"
        ...
        width={width}
        height={height}
        className={`prefix__svg-inline--fa prefix__fa-link prefix__fa-w-16 ${className}`}
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
      >
        <path
  ...
  export const Gear = ({ width, height, color }: SVGParams) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
  ...
  export const Develope = ({ width, height, color }: SVGParams) => {
    return (
      <svg
        aria-hidden="true"
        data-prefix="fas"
